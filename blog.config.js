...
const BLOG = {
  ...
  GREETING_WORDS:
    process.env.NEXT_PUBLIC_GREETING_WORDS || '一个程序员，欢迎来到我的博客🎉, 所有你乐于挥霍的时间，都不能算作浪费, 智慧，自由，和爱',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Lin', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || '所有你乐于挥霍的时间, 都不能算作浪费', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-theta-ebon.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, Lin, Blog, Lin's Blog', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'rtlin4@gmail.com', // 邮箱地址 例如mail@tangly1024.com
